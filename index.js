...
// const stripe = require('stripe')('sk_test_51QfloLEtdTWo1KNaLd65piF6MQsH6vk25IOatKVNEsrhsK2laTt82UmSlGw9a9vwzouyoPujBi6EbDVapC3keLBd00mXRFjir4');
...
async function run() {
   try {
      ...
      // verify Admin in middleware style
      ...
      // user isAdmin checking (IMPORTANCE) ====> we should do it a cental place
      ...
      app.post('/users', async (req, res) => {
         ...
         // insert email and name if user dont exist in database
      ...
      // payment intent for (secret token)
...
app.listen(port, () => {
   console.log(`bistro boss in running: ${port}`)
})
